...
function archiveToday(){const archive=JSON.parse(localStorage.getItem('banpetArchive')||'{}');archive[todayKey()]={earned:latestEarned,meetingSeconds:meetingSeconds(),frustration:daily.frustration,currency:$('#currency').value,pet:currentPet.id};localStorage.setItem('banpetArchive',JSON.stringify(archive))}
